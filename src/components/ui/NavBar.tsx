...
export function Navbar({ isVisible }: { isVisible: boolean }) {
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-0 left-0 w-full z-999999 flex justify-between items-center p-4 mix-blend-difference text-white transition-opacity duration-1000 delay-500 `}
      >
        <h1
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-[#212121] z-99999 flex flex-col justify-center px-10 md:px-32 lg:px-48"
          >
            {/* Main Menu Links */}
